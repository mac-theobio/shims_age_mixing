...
condom model 1
-1.1583 is the log-odds of falling into or below category 1 ("never") vs 2 ("sometimes") when age difference = 0.
0.5538 is the log-odds of falling into or below category 2 ("sometimes") vs 3 ("always") when age difference = 0.
The lower the value of age difference, the higher the probability of the response falling in the lower level i.e no condom use
