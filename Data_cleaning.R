...
T1.agemix <- Sample.Baseline %>% transmute(Uid = Uid,
                                           ...
                                           Condom.freq.p1 = as.factor(RQp1hocu),
                                           Condom.freq.p2 = as.factor(RQp2hocu),
                                           Condom.freq.p3 = as.factor(RQp3hocu),
                                           Sex.freq.p1 = as.factor(RQp1hm6s),
                                           Sex.freq.p2 = as.factor(RQp2hm6s),
                                           Sex.freq.p3 = as.factor(RQp3hm6s),
                                           Money.gifts.p1 = as.factor(RQp1grm),
                                           Money.gifts.p2 = as.factor(RQp2grm),
                                           Money.gifts.p3 = as.factor(RQp3grm),
                                           Partner.type.p1 = as.factor(RQp1psr),
                                           Partner.type.p2 = as.factor(RQp2psr),
                                           Partner.type.p3 = as.factor(RQp3psr))
